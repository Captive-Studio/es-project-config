<!-- AUTO-GENERATED-CONTENT:START (PKG_JSON:template=# Captive CSpell configuration _(${name})_) -->
# Captive CSpell configuration _(@captive/cspell-config)_
...
```console
npm install --save-dev @captive/cspell-config cspell
```
<!-- AUTO-GENERATED-CONTENT:END -->
...
[package-version-svg]: https://img.shields.io/npm/v/@captive/cspell-config.svg?style=flat-square
<!-- AUTO-GENERATED-CONTENT:END -->
<!-- AUTO-GENERATED-CONTENT:START (PKG_JSON:template=[package-url]: https://www.npmjs.com/package/${name}) -->
[package-url]: https://www.npmjs.com/package/@captive/cspell-config
<!-- AUTO-GENERATED-CONTENT:END -->
...
@captive/cspell-config is maintained and funded by Captive.
