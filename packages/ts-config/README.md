<!-- AUTO-GENERATED-CONTENT:START (PKG_JSON:template=# Captive Typescript configuration _(${name})_) -->
# Captive Typescript configuration _(@captive/ts-config)_
...
```console
npm install --save-dev @captive/ts-config
```
<!-- AUTO-GENERATED-CONTENT:END -->
...
[package-version-svg]: https://img.shields.io/npm/v/@captive/ts-config.svg?style=flat-square
<!-- AUTO-GENERATED-CONTENT:END -->
<!-- AUTO-GENERATED-CONTENT:START (PKG_JSON:template=[package-url]: https://www.npmjs.com/package/${name}) -->
[package-url]: https://www.npmjs.com/package/@captive/ts-config
<!-- AUTO-GENERATED-CONTENT:END -->
...
@captive/ts-config is maintained and funded by Captive.
